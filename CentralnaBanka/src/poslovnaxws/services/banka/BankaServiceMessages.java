...
public interface BankaServiceMessages {
    ...
    @WebMethod
    @SOAPBinding(parameterStyle = SOAPBinding.ParameterStyle.BARE)
    @WebResult(name = "status", targetNamespace = "PoslovnaXWS/Banke", partName = "presek")
    public poslovnaxws.banke.Presek zahtevZaIzvod(
        @WebParam(name = "zahtevZaIzvod", targetNamespace = "PoslovnaXWS/Banke")
